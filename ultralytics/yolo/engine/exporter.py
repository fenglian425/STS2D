...
class Exporter:
    ...
    def _export_torchscript(self, prefix=colorstr('TorchScript:')):
        ...
        ts = torch.jit.trace(self.model.cuda(), self.im.cuda(), strict=False)
    ...
    def _export_onnx(self, prefix=colorstr('ONNX:')):
        ...
        if dynamic:
            ...
            if isinstance(self.model, SegmentationModel):
                dynamic['output'] = {0: 'batch', 2: 'anchors'}  # shape(1,25200,85)
                dynamic['protos'] = {0: 'batch', 2: 'mask_height', 3: 'mask_width'}  # shape(1,32,160,160)
